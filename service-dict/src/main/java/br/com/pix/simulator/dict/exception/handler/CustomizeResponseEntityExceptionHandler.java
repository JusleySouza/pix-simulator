package br.com.pix.simulator.dict.exception.handler;

import br.com.pix.simulator.dict.config.LoggerConfig;
import br.com.pix.simulator.dict.dto.error.FieldError;
import br.com.pix.simulator.dict.dto.error.ResponseError;
import br.com.pix.simulator.dict.exception.ExceptionResponse;
...
public class CustomizeResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handleKeyNotFoundExceptions(Exception exception, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(
                new Date(), exception.getMessage(), request.getDescription(false));
        LoggerConfig.LOGGER_EXCEPTION.error(exception.getMessage());
    ...
    public final ResponseEntity<ExceptionResponse> handleKeyAlreadyExistsException(Exception exception, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(
                new Date(), exception.getMessage(), request.getDescription(false));
        LoggerConfig.LOGGER_EXCEPTION.error(exception.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleIllegalArgumentException(IllegalArgumentException ex) {
        LoggerConfig.LOGGER_EXCEPTION.warn("Invalid request: {}", ex.getMessage());
